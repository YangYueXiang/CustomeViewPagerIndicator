...
public class BannerIndicator extends LinearLayout {
    ...
    public BannerIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        dashGap = (int) array.getDimension(R.styleable.BannerIndicator_gap, Tool.dpToPx(context,10));
        slider_width = (int) array.getDimension(R.styleable.BannerIndicator_slider_width,
                Tool.dpToPx(context,55));
        slider_height = (int) array.getDimension(R.styleable.BannerIndicator_slider_height, Tool.dpToPx(context,10));
        sliderAlign = array.getInt(R.styleable.BannerIndicator_sleider_align, 0);
        array.recycle();
    }
